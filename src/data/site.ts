...
export const ui = {
  en: {
    ...
    allGames: "Board game strategy categories",
    readGuide: "Read strategy",
    sponsorTitle: "Best online Catan alternative",
    sponsorText:
      "Play Catan-style games online with friends at Colonist.io, our recommended place to practice trading, expansion, and robber timing.",
  ...
  tr: {
    ...
    allGames: "Kutu oyunu strateji kategorileri",
    readGuide: "Stratejiyi oku",
    sponsorTitle: "En iyi online Catan alternatifi",
    sponsorText:
      "Arkadaslarinla Catan tarzi oyunlar oynamak ve takas, yayilma, hirsiz zamanlamasi calismak icin Colonist.io'yu oneriyoruz.",
  ...
  de: {
    ...
    allGames: "Brettspiel-Strategien nach Kategorie",
    readGuide: "Strategie lesen",
    sponsorTitle: "Beste Online-Catan-Alternative",
    sponsorText:
      "Spiele Catan-aehnliche Partien online mit Freunden auf Colonist.io und trainiere Handel, Expansion und Raeuber-Timing.",
